...
export interface StoredState { players: Player[]; teamCount: number; mode: 'auto' | 'custom'; playersPerTeam: number; teamNames: string[]; matchName?: string; matchDate?: string; captainMode?: 'none' | 'before' | 'after' | 'random'; captainId?: string }
